...
interface CreateFournisseurProps {
    onSuccess?: () => void;
}

export default function CreateFournisseur({ onSuccess }: CreateFournisseurProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/fournisseurs', {
            onSuccess: () => {
                showToast(t('supplier_created_success'), 'success');
                reset();
                setIsOpen(false);
                if (onSuccess) {
                    onSuccess();
            ...
            onError: (errors) => {
                showToast(t('supplier_create_error'), 'error');
            },
        });
    };
