...
import { ArrowLeft, Calendar, User, FileText, Monitor, Users, Phone, MapPin, Package, Hash, DollarSign, Coins, Download } from 'lucide-react';
            ...
            <div className="py-4 sm:py-6 md:py-8 lg:py-12">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                    ...
                    <div className={`mb-4 sm:mb-6 flex items-center gap-3 ${locale === 'ar' ? 'flex-row-reverse' : ''}`}>
                        ...
                        <Button
                            onClick={() => window.open(`/bl-clients/${bonLivraison.id}/download`, '_blank')}
